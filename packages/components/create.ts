...
import { configNamespace, configProps, configLocale, configZIndex } from '@db-plus/config';
import { toCapitalCase } from '@db-plus/utils';

import type { Ref, App } from 'vue';
import type { PropsOptions, LocaleOptions } from '@db-plus/config';
